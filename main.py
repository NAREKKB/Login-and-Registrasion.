...
def Register_User():
    ...
    if not is_password_valid(create_password):
        messagebox.showerror("error",
                             "Password must be at least 8 charters long and includes:\n"
...
def register():
    ...
    eye_button_confirm.place(x=290, y=190)
    ...
    tk.Button(reg_frame, text='back to Login', bg='white', fg='blue', border=0, font=('Arial', 8, 'bold'),
              cursor='hand2', command=show_Login_screen).place(x=135, y=320)
